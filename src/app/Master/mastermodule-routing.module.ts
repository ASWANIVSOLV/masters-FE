...
const routes: Routes = [
 ...
 children:[ 
  ...
  // { path:'mailtempcrt',component:MailTemplateCreateComponent,canActivate:[CanActivateGuardService]},
  // { path:'mailtempedit',component:MailTemplateEditComponent,canActivate:[CanActivateGuardService]},
  // { path:'mailtempsum',component:MailTemplateComponent,canActivate:[CanActivateGuardService]},
