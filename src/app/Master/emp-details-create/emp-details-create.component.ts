...
export class EmpDetailsCreateComponent implements OnInit {
  ...
  det_previous:boolean=false;
  det_next:boolean=false;
  det_currentpage:number=1;
  emplcontact_details:any=[];
  pageSize:number=10;
  presentpage:number=1;
  contactType={5:'EMPLOYEE',10:'GROUP123',15:'Individual'};

  constructor(private dataService: DataService,private router:Router,private datepipe:DatePipe,private spinner:NgxSpinnerService,private notification:NotificationService,private fb:FormBuilder,private masterservice:masterService) { }
  ...
  getdesignation(){
    this.masterservice.getDesignationList1('','asc',this.designpage,'').subscribe(data=>{
    ...
    .pipe(
      ...
      switchMap(value => this.masterservice.getDesignationList1('','asc',this.designpage,value)
        .pipe(
          finalize(() => {
            this.isLoading = false
          }),
  ...
  getccdata(){
    ...
    pipe(
      ...
      switchMap((value:any)=>this.masterservice.getccdatafilter(this.createemployss.get('bsname').value.id,'',1).pipe(
        finalize(()=>{
          this.isLoading=false;
        })
      ))
  ...
  getpinlistfocus(data:any){
    console.log(data);
    this.createemployss.get('city').patchValue({
      name : data['city'].name,
      id : data['city'].id,
    });
    this.createemployss.get('district').patchValue({
      name : data['district'].name,
      id : data['district'].id,
    });
    this.createemployss.get('state').patchValue({
  ...
  getcityfocus(data:any){
    ...
    this.createemployss.get('district').patchValue(data['district']['name']);
    this.createemployss.get('state').patchValue(data['state']['name']);
  }
  getcitydata(){
    let d:any='';
          ...
          .subscribe(x => {
            ...
            if (atBottom) {
              if (this.has_designnext === true) {
                this.masterservice.getDesignationList1('','asc',this.designpage+1,this.designinput.nativeElement.value)
  ...
  employeecreatedata(){
    ...
    if(!(this.createemployss.get('entity').value)){
      this.notification.showError('Please Select The Entity');
      return false;
    }
    ...
    if(this.emplcontact_details.length==0){
      this.notification.showWarning("Please Select Contact Details And Save")
      return false;
    ...
    //   this.notification.showError('Please Enter The Contact Wedding Day');
    //   return false;
    // }
    console.log(this.createemployss.value);
    let Gender:any={'Male':1,"Female":2,"TransGender":3};
    let contactType={'EMPLOYEE':5,'GROUP123':10,'Individual':15};
    let data:any={
      "entity_id":this.createemployss.get('entity').value,
      ...
      "contact":this.emplcontact_details,
      // "contact":{
    ...
    // this.emplcontact_details=data;
    this.spinner.show();
    this.masterservice.getlistdepartmentcreate_2(data).subscribe(datas=>{
      console.log(datas);
      this.spinner.hide();
  ...
  contactdata(){
    let contype=this.createemployss.get('contacttype').value
    let designation=this.createemployss.get('condesignation').value.id
    let filt=this.emplcontact_details.some(t=>t.type == contype)
    if(filt){
      this.notification.showWarning("Contact Type Already Choosen")
      return false;
    }
    if(this.createemployss.get('contacttype').value==null || this.createemployss.get('contacttype').value==undefined || this.createemployss.get('contacttype').value=="" ){
      this.notification.showError('Please Enter The ContactType');
      return false;
    }
    if(this.createemployss.get('personname').value==null || this.createemployss.get('personname').value==undefined || this.createemployss.get('personname').value==""){
      this.notification.showError('Please Enter The Person Name');
      return false;
    }
    if(!designation){
    ...
    if(this.createemployss.get('landline1').value.length !=10 || this.createemployss.get('landline1').value==undefined || this.createemployss.get('landline1').value==""){
      this.notification.showError('Please Enter The landline1');
      return false;
    }
    if(this.createemployss.get('landline2').value.length !=10 || this.createemployss.get('landline2').value==undefined || this.createemployss.get('landline2').value=="" ){
      this.notification.showError('Please Enter The landline2');
      return false;
    }
    if(this.createemployss.get('contactnumber').value.length !=10 || this.createemployss.get('contactnumber').value==undefined || this.createemployss.get('contactnumber').value=="" ){
      this.notification.showError('Please Enter The Contactnumber');
      return false;
    }
    if(this.createemployss.get('contactnumber2').value.length !=10 || this.createemployss.get('contactnumber2').value==undefined || this.createemployss.get('contactnumber2').value=="" ){
      this.notification.showError('Please Enter The Contactnumber');
      return false;
    }
    if(this.createemployss.get('conemailid').valid==false || this.createemployss.get('conemailid').value==undefined || this.createemployss.get('conemailid').value=="" || this.createemployss.get('conemailid').value==''){
    ...
    let data={
      "type":this.createemployss.get('contacttype').value,
      "type_id":contactType[this.createemployss.get('contacttype').value],
      "name":this.createemployss.get('personname').value,
      "designation_id":this.createemployss.get('condesignation').value.id,
      "designation":this.createemployss.get('condesignation').value.name,
      "landline":this.createemployss.get('landline1').value,
      "landline2":this.createemployss.get('landline1').value,
      "mobile":this.createemployss.get('contactnumber').value,
      "mobile2":this.createemployss.get('contactnumber2').value,
      "email":this.createemployss.get('conemailid').value,
      "dob":this.datepipe.transform(this.createemployss.get('condob').value,'yyyy-MM-dd'),
      "wedding_date":this.datepipe.transform(this.createemployss.get('conwedday').value,'yyyy-MM-dd'),
      "status":1
  
    }
    this.emplcontact_details.push(data);
    this.createemployss.get('contacttype').reset(),
    this.createemployss.get('personname').reset(),
    this.createemployss.get('condesignation').reset(),
    this.createemployss.get('landline1').reset(),
    this.createemployss.get('landline2').reset(),
    this.createemployss.get('contactnumber').reset(),
    this.createemployss.get('contactnumber2').reset(),
    this.createemployss.get('conemailid').reset(),
    this.createemployss.get('condob').reset(),
    this.createemployss.get('conwedday').reset()
    console.log(this.emplcontact_details)
